...
import com.game.onecricket.Bean.BeanAddCashOfferList;
import com.game.onecricket.R;
import com.game.onecricket.utils.SessionManager;
import com.game.onecricket.databinding.ActivityAddCashBinding;
...
import static com.game.onecricket.APICallingPackage.Config.ADDAMOUNTOFFER;
import static com.game.onecricket.APICallingPackage.Constants.ADDAMOUNTOFFERTYPE;
        ...
        binding.tvAddCash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (FinalAmountToAdd.equals("")) {
                    ...
                    Intent i = new Intent(activity, com.game.onecricket.activity.PaymentOptionActivity.class);
