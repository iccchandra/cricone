...
import com.game.onecricket.databinding.ActivityVerifyOtpBinding;
...
import static com.game.onecricket.APICallingPackage.Config.FORGOTPASSWORD;
import static com.game.onecricket.APICallingPackage.Config.VERIFYFORGOTPASSWORD;
import static com.game.onecricket.APICallingPackage.Constants.FORGOTPASSWORDTYPE;
import static com.game.onecricket.APICallingPackage.Constants.VERIFYFORGOTPASSWORDTYPE;


public class ForgotVerifyOTPActivity extends AppCompatActivity implements com.game.onecricket.APICallingPackage.Interface.ResponseManager {


    com.game.onecricket.APICallingPackage.Interface.ResponseManager responseManager;
    com.game.onecricket.APICallingPackage.Class.APIRequestManager apiRequestManager;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiRequestManager = new com.game.onecricket.APICallingPackage.Class.APIRequestManager(activity);
        initView();
        Intent o = getIntent();
    ...
    public void getResult(Context mContext, String type, String message, JSONObject result) {
        ...
        if (type.equals(VERIFYFORGOTPASSWORDTYPE)) {
            ...
            try {
                Intent i = new Intent(activity, com.game.onecricket.activity.NewPasswordActivity.class);
