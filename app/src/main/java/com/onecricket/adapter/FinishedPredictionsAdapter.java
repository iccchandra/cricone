...
public class FinishedPredictionsAdapter extends RecyclerView.Adapter<FinishedPredictionsAdapter.MyPredectionsViewHolder>{


    private Context context;
    private List<Finished> upcomingList;

    public FinishedPredictionsAdapter(Context context, List<Finished> upcomingList) {
    ...
    public MyPredectionsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FinishedPredictionsAdapter.MyPredectionsViewHolder(listItem);
    }

    @Override
    public void onBindViewHolder(@NonNull MyPredectionsViewHolder holder, int position) {
        Finished upcoming = upcomingList.get(position);
